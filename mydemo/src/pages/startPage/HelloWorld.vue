            ...
            <div class="dryMachine areaBorderStyle">
              ...
              <div @click="linkDetail1(32, '烘干机')" style="cursor: pointer">
                <one-cell
                  :device="arb8"
                  :color="
                    this.$store.state.WebsocketMessage.Equipment32_FaultStatus
                  "
                  class="dry-two"
                ></one-cell>
              </div>
          ...
          <div class="da-container">
            ...
            >
              ...
              <div
                ...
                :style="{
                  backgroundColor:
                    this.$store.state.WebsocketMessage.Equipment34_FaultStatus,
                }"
              ></div>
            </div>
      ...
      <div class="tableCon">
        <div class="rightBox">
          <dv-border-box-11 title="1#车丝机振动">
            ...
            <div class="dvGraph" ref="chartRing" v-if="scrollChange">
