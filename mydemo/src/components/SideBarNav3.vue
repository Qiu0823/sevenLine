<template>
  <div class="firstNav">
    ...
    <div
      class="first"
      v-for="(firstItem, firstIndex) in firstList"
      :key="firstItem.areaId"
      @mouseenter="handleEnter1($event, firstIndex)"
    >
      <!--第一层 标题 -->
      <div class="firstTitle">
        <div
          class="greenBtn"
          :style="{
            backgroundColor: WebsocketMessage['Data1_' + firstItem.areaId],
          }"
        ></div>
        ...
        >
          ...
          <div class="secondTitle">
            ...
            <div
              ...
              :style="{
                backgroundColor:
                  WebsocketMessage['Data2_' + secondItem.areaTypeId],
              }"
            ></div>
          ...
          <div class="thirdWraper">
            ...
            >
              <div class="titleWrap">
                <div
                  class="greenBtn"
                  :style="{ backgroundColor: WebsocketMessage[thirdItem.data] }"
                ></div>
  ...
  methods: {
    ...
    handleEnter1(e, i) {
      if (i !== 8) {
        ...
        var overHeight =
          secWrap.clientHeight +
          secWrap.getBoundingClientRect().y -
    ...
    handleEnter2(e, i, i2) {
      if (i2 !== 8) {
        var overHeight =
          e.target.childNodes[1].clientHeight +
          e.target.childNodes[1].getBoundingClientRect().y -
          document.documentElement.clientHeight;
        if (overHeight > 0) {
